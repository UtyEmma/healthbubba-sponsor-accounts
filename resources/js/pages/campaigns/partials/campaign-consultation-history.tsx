...
export function CampaignConsultationHistory({
    consultations,
    campaignSlug,
}: {
    ...
    return (
        <CardContent className="flex min-h-64 flex-col items-center justify-center px-6 py-12 text-center">
            ...
            <p className="mt-1 max-w-sm text-sm text-muted-foreground">
                Consultations for this campaign's beneficiaries will appear
                here.
            </p>
        </CardContent>
    );
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2">
                {consultations.meta.current_page > 1 ? (
                    <Link
                        href={campaigns.show(campaignSlug, {
                            query: { consultations_page: previousPage },
                        })}
                        preserveScroll
                ...
                consultations.meta.last_page ? (
                    <Link
                        href={campaigns.show(campaignSlug, {
                            query: { consultations_page: nextPage },
                        })}
                        preserveScroll
                        className={buttonVariants({
                            variant: 'outline',
