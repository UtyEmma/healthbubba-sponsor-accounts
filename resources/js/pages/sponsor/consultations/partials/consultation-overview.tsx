...
const allocations = [
    ['3 users', '5 scheduled', '2 instant'],
    ['4 users', '7 scheduled', '2 instant'],
    ['5 users', '9 scheduled', '2 instant'],
    ['5 users', '11 scheduled', '2 instant'],
] as const;
        ...
        >
            <Card className="min-h-[319px]">
                ...
                <CardContent className="grid gap-5 px-6 pt-3 pb-6">
                    {coverage.allocations.map((allocation) => (
                        <PoolProgress allocation={allocation} />
                    ))}
                </CardContent>
            </Card>
            ...
            <Card className="min-h-[319px] overflow-hidden">
                <CardHeader className="px-6 pt-6 pb-4">
                    ...
                    <p className="text-sm leading-5 text-muted-foreground">
                        Each extra beneficiary adds +2 scheduled consultations
                        to the shared pool (instant count is fixed).
                    </p>
                </CardHeader>
