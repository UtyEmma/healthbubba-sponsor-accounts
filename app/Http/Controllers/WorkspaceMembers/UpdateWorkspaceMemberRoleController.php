...
final readonly class UpdateWorkspaceMemberRoleController
{
    ...
    public function __invoke(UpdateWorkspaceMemberRoleRequest $request): RedirectResponse
    {
        $this->updateRole->execute($request->target(), WorkspaceMemberRole::from($request->validated('role')));
