...
abstract class ManageInstitutionalCampaignRequest extends AuthorizedInstitutionalWorkspaceRequest
{
    public function authorize(): bool
    {
        ...
        return WorkspaceMember::query()
            ...
            ->whereIn('role', [WorkspaceMemberRole::Owner->value, WorkspaceMemberRole::Administrator->value])
            ->exists();
    }
