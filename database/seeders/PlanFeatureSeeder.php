...
class PlanFeatureSeeder extends Seeder
{
    ...
    private function featureDefinitions(): array
    {
        return [
            ...
            Features::GP_CONSULTATIONS_PER_SEAT->value => $this->limit(Features::GP_CONSULTATIONS_PER_SEAT->label(), 'Monthly GP consultation allowance for each employee seat.', 11),
            Features::SPECIALIST_CONSULTATIONS_PER_SEAT->value => $this->limit(Features::SPECIALIST_CONSULTATIONS_PER_SEAT->label(), 'Monthly specialist consultation allowance for each employee seat.', 12),
