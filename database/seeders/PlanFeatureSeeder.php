...
class PlanFeatureSeeder extends Seeder
{
    ...
    private function featureDefinitions(): array
    {
        return [
            ...
            Features::GP_CONSULTATIONS_PER_SEAT->value => $this->limit(Features::GP_CONSULTATIONS_PER_SEAT->label(), 'Monthly scheduled consultation allowance for each employee seat.', 11),
            Features::SPECIALIST_CONSULTATIONS_PER_SEAT->value => $this->limit(Features::SPECIALIST_CONSULTATIONS_PER_SEAT->label(), 'Monthly instant consultation allowance for each employee seat.', 12),
            Features::EMPLOYEE_SEAT_MANAGEMENT->value => $this->toggle(Features::EMPLOYEE_SEAT_MANAGEMENT->label(), 'Provision and manage isolated employee coverage seats.', 13),
    ...
    private function planDefinitions(): array
    {
        ...
        return [
            ...
            'business-premium' => $this->plan(
                ...
                sortOrder: 2,
                features: [
                    Features::GP_CONSULTATIONS_PER_SEAT->value => ['value' => '3', ...$monthlyReset],
                    Features::SPECIALIST_CONSULTATIONS_PER_SEAT->value => ['value' => '1', ...$monthlyReset],
                    Features::ON_DEMAND_CONSULTATIONS->value => [],
                    Features::SCHEDULED_APPOINTMENTS->value => [],
                    Features::EMPLOYEE_SEAT_MANAGEMENT->value => [],
                    Features::BULK_HR_UPLOAD_AND_LIST_EXPORT->value => [],
